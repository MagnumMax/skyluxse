...
-- 2025-12-26: Force all auto-created tasks to be assigned to the single Driver Account
-- This ensures tasks are always visible to the main driver login
...
begin
  ...
  -- FORCE SINGLE DRIVER ASSIGNMENT
  -- Ignore booking.driver_id and always assign to the main Driver Account
  assignee_id := default_driver_id;
