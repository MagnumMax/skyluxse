-- Migration to update create_task_from_calendar_event function
-- Changes:
-- 1. Sets default_driver_id to '07c91c85-62c8-44dd-8351-ef78826e633f'
-- 2. Uses coalesce(booking_record.driver_id, default_driver_id) to assign driver
